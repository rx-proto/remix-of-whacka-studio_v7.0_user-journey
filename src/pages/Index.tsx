        ...
        {showHomeGate && (
          ...
          >
            ...
            <div className="relative z-10 text-center px-8 flex flex-col items-center gap-6" style={{ marginTop: '-10vh' }}>
              ...
              <AnimatePresence>
                {gateExpanded && (
                  <motion.div
                    ...
                    className="w-full max-w-[280px] space-y-2.5 overflow-hidden"
                  >
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="Email"
                        className="w-full h-11 pl-10 pr-4 rounded-full text-sm text-slate-900 placeholder:text-slate-400 outline-none bg-white border border-slate-200"
                      />
                    </div>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full h-11 pl-10 pr-11 rounded-full text-sm text-slate-900 placeholder:text-slate-400 outline-none border"
                        style={{
                          background: gatePassword ? '#1e293b' : '#fff',
                          borderColor: gatePassword ? '#1e293b' : '#e2e8f0',
                          color: gatePassword ? '#fff' : undefined,
                        }}
                        onKeyDown={e => { if (e.key === 'Enter' && gatePassword) { setShowHomeGate(false); setGateExpanded(false); login(gateEmail, gatePassword); } }}
                      />
                      <button
                        onClick={() => { if (gatePassword) { setShowHomeGate(false); setGateExpanded(false); login(gateEmail, gatePassword); } }}
                        className="absolute right-3 top-1/2 -translate-y-1/2"
                      >
                        <ArrowRight size={16} className={gatePassword ? 'text-white' : 'text-slate-300'} />
                      </button>
                    </div>
                  </motion.div>
                )}
              ...
              {/* Sign in with Google */}
              <motion.button
                className="w-full max-w-[280px] px-6 py-3 rounded-full text-sm font-semibold text-slate-800 bg-white border border-slate-200 min-h-[44px] flex items-center justify-center gap-2 active:bg-slate-50"
                whileTap={{ scale: 0.96 }}
              >
